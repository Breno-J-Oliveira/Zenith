    ...
    <>
      <header className="fixed top-0 left-0 right-0 h-16 bg-[var(--color-surface-1)]/95 backdrop-blur-md border-b border-[var(--color-surface-2)] flex items-center justify-between px-6 z-50 header-hud">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/settings"
            className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[var(--color-primary)]/20 border border-[var(--color-primary)]/30 text-[var(--color-primary)] text-sm font-medium hover:bg-[var(--color-primary)]/30 transition-all duration-200"
            title="Configurações"
          >
